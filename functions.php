...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        wp_register_style( 'wpbs', get_template_directory_uri() . '/library/dist/css/styles.0bf8fb31.min.css', array(), '1.0', 'all' );
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {  
  function wp_bootstrap_theme_js(){
    ...
    //   get_template_directory_uri() . '/library/dist/js/scripts.af2c6ec1.min.js',
    //   array('bootstrap'), 
    //   '1.2' );
    ...
    wp_register_script( 'smoothScroll', 
      get_template_directory_uri() . '/library/js/jss-script.min.js', 
      array('jquery'), 
      '1.2' );

     wp_register_script( 'custom', 
      get_template_directory_uri() . '/library/js/custom.js', 
      array('jquery'), 
      '1.2' );
